...
export const NHL_TEAM_RATINGS: Record<string, NHLTeamRating> = {
  ANA: {
    ...
    shotsAgainstPerGame: 32.5,
    paceMinutes: 1.0,
    goalsForPerGame: 2.6,
    goalsAgainstPerGame: 3.4,
  },
  UTA: {
    xGFperGame: 3.05,
    xGAperGame: 2.95,
  ...
  CHI: {
    ...
    ppPct: 17.0,
    pkPct: 75.5,
    shotsForPerGame: 27.0,
    shotsAgainstPerGame: 33.5,
    paceMinutes: 1.0,
    goalsForPerGame: 2.5,
    goalsAgainstPerGame: 3.6,
  },
  COL: {
    xGFperGame: 3.25,
    xGAperGame: 2.75,
  ...
  FLA: {
    ...
    ppPct: 23.5,
    pkPct: 83.0,
    shotsForPerGame: 31.0,
    shotsAgainstPerGame: 27.5,
    paceMinutes: 1.02,
    goalsForPerGame: 3.2,
    goalsAgainstPerGame: 2.6,
  },
...
export function getNHLTeamRating(abbrev: string): NHLTeamRating {
  return (
    NHL_TEAM_RATINGS[abbrev.toUpperCase()] ?? {
      xGFperGame: 3.0,
      xGAperGame: 3.0,
      ppPct: 21,
      pkPct: 79,
