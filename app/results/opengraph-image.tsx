...
export const alt = "Quant Betting — Track Record";
...
async function getStats() {
  ...
  try {
    const res = await fetch(`${base}/api/results?days=30`, {
      next: { revalidate: 600 },
    });
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", marginTop: 40, gap: 24 }}>
        ...
        >
          <div style={{ fontSize: 16, color: "#8e9ab5", letterSpacing: 2 }}>
            PROFIT
          </div>
          <div
            style={{
      ...
      >
        <div style={{ display: "flex", fontSize: 22, color: "#e6eaf4" }}>
