...
export const alt = "Quant Betting — AI-Powered Sports Betting Intelligence";
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        <span style={{ color: "#2ee6a6" }}>+EV picks&nbsp;</span>
      ...
      >
        Self-learning 3-model brain · Live arbs · Player props · Sharp money
        tracker
      </div>
      ...
      >
        ...
        <div style={{ fontSize: 20, color: "#8e9ab5", letterSpacing: 1 }}>
